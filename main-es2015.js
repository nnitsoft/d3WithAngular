...
let AppComponent = class AppComponent {
    ...
    initAxis() {
        ...
        this.x.domain(_statistics__WEBPACK_IMPORTED_MODULE_6__["STATISTICS"].map(d => d.letter));
        this.y.domain([0, d3_array__WEBPACK_IMPORTED_MODULE_4__["max"](_statistics__WEBPACK_IMPORTED_MODULE_6__["STATISTICS"], d => d.frequency)]);
    }
    drawAxis() {
        this.g
            .append("g")
